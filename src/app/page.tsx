...
const showcaseCells = [
  ...
  {
    src: "/images/terpene-science.jpg?v=aromatic",
  ...
  {
    src: "/images/lab-molecular.jpg?v=phenol",
    alt: "Molecular analysis in the TerpForge laboratory",
  ...
  {
    src: "/images/forge-process.jpg?v=cbda",
  ...
  {
    src: "/images/tech-life-2.jpeg?v=iridescent",
  ...
  {
    src: "/images/forge-process.jpg?v=organic",
    alt: "TerpForge extraction and forging process",
  ...
  {
    src: "/images/lab-molecular.jpg?v=benzene",
    alt: "Molecular analysis in the TerpForge laboratory",
  ...
  {
    src: "/images/terpene-science.jpg?v=compound-structure",
    alt: "Terpene science and compound isolation",
